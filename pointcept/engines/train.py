...
# Register training-only hooks here.  Keeping them out of hooks/__init__.py
# avoids a circular import when tools/test.py imports models -> HookBase.
from .hooks import misc as _hooks_misc
from .hooks import evaluator as _hooks_evaluator
